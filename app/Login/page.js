...
const page = () => {
  return (
    <div className='text-white py-40 flex flex-col gap-5 items-center content-center'>
        <h2 className='text-center font-bold text-[25px] tracking-[1px]'>Login to Get Started</h2>
